    ...
    return (
        <div className="min-h-screen bg-gray-light dark:bg-gray-veryDark p-6">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Link
                    to="/cms/list"
                    className="bg-primary light:bg-primary hover:bg-primary-light text-white p-6 rounded-lg shadow-md flex items-center space-x-4 transform transition-transform duration-300 hover:scale-105"
                >
                    <FiEye size={32} />
